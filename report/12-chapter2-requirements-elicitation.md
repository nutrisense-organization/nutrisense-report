...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>Plataforma web SaaS con registro nutricional, Smart Scan (análisis de fotos de platos y menús), motor de recomendaciones contextuales por clima y ubicación, Modo Viaje, módulo de despensa, sincronización con Google Health, dashboard de progreso y exportación de reportes PDF.</td>
...
![nombre](../assets/img/chapter2-neeedfinding-images/JorgeDelAguilaVacalla(2).jpeg)

**Segmento 2: Ganancia de masa muscular**

![nombre](../assets/img/chapter2-neeedfinding-images/DaphneFaustorVergaray(1).jpeg)
